...
function DashboardShellContent({ children, user }: { children: React.ReactNode, user: any }) {
    ...
    return (
        <div className="flex h-screen bg-background text-foreground overflow-hidden font-sans">
            ...
            <main className={`flex-1 flex flex-col min-w-0 overflow-hidden relative bg-background ${isVisitor ? 'h-screen' : ''}`}>
                {/* Top Header */}
                {!isVisitor && (
