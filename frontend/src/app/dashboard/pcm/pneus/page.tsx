        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-400 text-sm">Controle de vida útil, sulcos e movimentações.</p>
                </div>
                ...
                {pneus.map((pneu) => (
                    <div key={pneu.id} className="bg-surface border border-border-color p-4 rounded-xl hover:border-primary/30 transition-all group">
                        <div className="flex justify-between items-start mb-3">
                            <span className="text-lg font-bold text-white font-mono bg-surface-highlight px-2 py-0.5 rounded border border-white/5">{pneu.codigoPneu}</span>
                        ...
                        <div className="space-y-2 mb-4">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-gray-300">{pneu.medida}</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-gray-500">Sulco Atual:</span>
                                <span className={`font-bold ${pneu.sulcoAtualMm < 3 ? 'text-red-500' : 'text-emerald-400'}`}>{pneu.sulcoAtualMm} mm</span>
                            </div>
                        </div>
