export default function LocalizacaoPage() {
    return (
        <div className="p-6 bg-surface border border-border-color rounded-xl h-[80vh] flex items-center justify-center flex-col text-center">
            <h2 className="text-2xl font-bold text-foreground mb-2">Localização da Frota</h2>
            <p className="text-gray-500 dark:text-gray-400">Mapa de Veículos em Tempo Real</p>
